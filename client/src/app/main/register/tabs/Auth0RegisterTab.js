...
class Auth0RegisterTab extends Component {
    ...
    onSubmit = (model) => {
        this.props.registerWithCandidate(model);
    };
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        registerWithCandidate: authActions.registerWithCandidate
    }, dispatch);
}
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(Auth0RegisterTab));
